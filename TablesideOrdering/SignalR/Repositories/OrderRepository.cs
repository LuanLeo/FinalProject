...
namespace TablesideOrdering.SignalR.Repositories
{
    public class OrderRepository
    {
        ...
        {
            var query = "SELECT OrderId, OrderDate, OrderPrice, ProductQuantity, PhoneNumber, TableNo, Status, CusName, OrderType, Address, PickTime, CouponId, PaymentType FROM Orders";
